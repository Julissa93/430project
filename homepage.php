...
<html lang="en">
   <head>
      ...
      <title>Name of Tutoring Center</title>
      ...
      <link rel="canonical" href="https://codepen.io/jcoulterdesign/pen/qdWxEm?limit=all&page=59&q=box" />
      <style class="cp-pen-styles">@import url(https://fonts.googleapis.com/css?family=Roboto:400,700,300);
         ul {
         padding: 0;
         margin: 0;
         }
   ...
   <body>
      ...
      <div class='swanky'>
         ...
         <div class='swanky_title'>
            <h1>NAME OF THE TUTORING CENTER</h1>
            <p>MOTTO WE WANT TO PUT HERE</p>
         ...
         <div class='swanky_wrapper'>
            ...
            <input id='submit_things' name='submit_things' type='radio'>
            <label for='submit_things'>
